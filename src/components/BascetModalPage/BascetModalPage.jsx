  ...
  const newAddedItems = addedItems.map((item, index) => (
    <div key={index + 5} className="addedItem">
      ...
      <div className="itemQuantityContainer">
        ...
        <span>{addedItems[index].quantity}</span>
        <div className='plusBtn quantityBtns'
          onClick={() => {
      ...
      <div className="itemTotalPrice">Total : {item.price * item.quantity} $</div>
